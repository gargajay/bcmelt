...
Route::prefix('admin')->middleware('theme:dashboard')->name('admin.')->group(function(){
        ...
        Route::middleware(['auth:admin'])->group(function(){
            ...
            Route::post('/add_new_student_exam',[AdminController::class,'add_new_students_exam']);

            
            Route::post('/question-import',[AdminController::class,'questionImport']);
...
Route::prefix('student')->middleware('theme:dashboard')->name('student.')->group(function(){
    ...
    Route::middleware(['auth:web'])->group(function(){    
        ...
        Route::get('/rejoin/{id}',[StudentOperation::class,'rejoin']);
